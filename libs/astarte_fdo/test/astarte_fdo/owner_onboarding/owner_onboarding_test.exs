...
defmodule Astarte.FDO.OwnerOnboarding.OwnerOnboardingTest do
  ...
  setup_all %{realm_name: realm_name} do
    ...
    {:ok, namespace} = Secrets.Vault.create_owner_key_namespace(realm_name, key_alg)
    ...
    {:ok, namespace} = Astarte.Secrets.Vault.create_owner_key_namespace(realm_name, key_alg)
