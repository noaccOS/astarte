...
defmodule Astarte.AppEngine.API.Device.Attributes do
  ...
  defp apply_delete(changeset, delete_attributes) when length(delete_attributes) == 0, do: changeset
  ...
  defp apply_update(changeset, update_attributes) when length(update_attributes) == 0, do: changeset
